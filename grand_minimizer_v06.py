...
### Check Bonds Plot   SEEMS OKAY
### Calculate Bond Energies and Gradients (strain)
...
class Island():
    ...
    def grad_surf(self, d=0.0001):
        ...
        Es = [self.surface_energy(self.xy + offset[:, None]) for offset in offsets]
